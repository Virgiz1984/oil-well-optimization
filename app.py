...
st.title("🛢️ Оптимизация выбора интервала испытания в нефтяной скважине")
st.markdown("---")
...
if uploaded_file is not None:
    ...
    - `DEPTH` - глубина (м)
    - `fill_cb_res` - полная вероятность нефтепроявления
    - `KVS_fin` - коэффициент связанной водонасыщенности
